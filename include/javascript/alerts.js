...
return false;};Alerts.prototype.updateManager=function(){if(typeof Alerts.prototype.lastUpdatedManager==='undefined'){Alerts.prototype.lastUpdatedManager=new Date().getTime();}else if(Alerts.prototype.lastUpdatedManager<(new Date().getTime()+1000)){return;}
