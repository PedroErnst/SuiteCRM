...
require_once('custom/modules/Configurator/CustomConfigurator.php');
...
echo getClassicModuleTitle(
    ...
    array(
        ...
        $mod_strings['LBL_KASHFLOW_GROUP_TITLE'],
    ),
    false
);

$cfg = new CustomConfigurator();
...
$sugar_smarty->assign('LOADING_GIF', $loadingGif);
...
$sugar_smarty->display('custom/modules/Administration/KashflowConfiguration.tpl');
